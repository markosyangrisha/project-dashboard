...
const ReferenceCurrencies: FC = () => {
	...
	return (
		<>
			<h2 className='text-2xl mb-5 font-medium text-[#242425]'>
			...
			<table className={classes.table}>
				<thead className={classes.thead}>
					<tr className='text-[13px] h-[50px]'>
						...
						<th className='px-4 font-semibold text-center border-r'>Price</th>
						<th className='px-4 font-semibold text-center'>Market Cap</th>
					</tr>
				</thead>
				{error && <p>{error}</p>}
